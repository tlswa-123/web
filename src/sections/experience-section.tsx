          ...
          return (
            ...
            >
              ...
              >
                ...
                {exp.id === "maipal" ? (
                  <div className="maipal-layout">
                    <div className="maipal-copy">
                      <p className="mb-5 max-w-none border-l-2 border-[#ff8a4c]/60 pl-5 text-lg leading-relaxed text-white/80 md:text-xl">
                        {exp.headline}
                      </p>
                      {modulesContent}
                      {tagsContent}
                    </div>
                    <div className="maipal-book-wrap">
                      <PageTurnBook />
                    </div>
                  </div>
                ) : (
